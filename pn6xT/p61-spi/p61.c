        ...
        unsigned long arg)
{
    ...
    break;
    case P61_SET_SPM_STATUS:
        P61_DBG_MSG(KERN_ALERT " P61_SET_SPM_STATUS: enter");
        ret = pn544_dev_ioctl(filp, P61_SET_PWR_STATUS, arg);
        P61_DBG_MSG(KERN_ALERT " P61_SET_SPM_STATUS: exit");
    break;
...
static int p61_probe(struct spi_device *spi)
{
    ...
    P61_DBG_MSG("%s MAX SPI Speed : %d Hz\n",__FUNCTION__,spi->max_speed_hz);
